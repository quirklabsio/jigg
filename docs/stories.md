...
- [ ] Story 8: Rotate a piece/group (double-tap, 90° increments)
...
## Current Session
Last completed: Story 7 — Refactor to group model + drag bug fixes (z-index, hit accuracy)
Next: Story 8 — Rotate a piece/group (double-tap, 90° increments)
Known issues: —
